...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
    ...
    $query=mysqli_query($con, "insert into  services(service_name,description,price,image) value('$sername','$serdesc','$cost','$newimage')");
    if ($query) {
...
<html>
<head>
<title>GlarmourGrid | Add Services</title>
