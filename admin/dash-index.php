...
?>
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query4=mysqli_query($con,"Select * from bookings where Status='1'");
...
?>
					...
					<div class="col-md-4 widget states-last">
						<?php
//todays sale
 $query6=mysqli_query($con,"select invoice.service_Id as ServiceId, services.price
 from invoice 
  join services  on services.ID=invoice.ServiceId where date(posting_date)=CURDATE();");
 ...
 ?>
				...
				<div class="row calender widget-shadow">
					...
					<div class="col-md-4 widget">
						<?php
//Yesterday's sale
 $query7=mysqli_query($con,"select invoice.service_Id as ServiceId, services.price
 from invoice 
  join services  on services.ID=invoice.ServiceId where date(posting_date)=CURDATE()-1;");
...
$yesterdaysale+=$yesterdays_sale;
 ...
 ?>
					...
					<div class="col-md-4 widget states-mdl">
						<?php
//Last Sevendays Sale
 $query8=mysqli_query($con,"select invoice.service_Id as ServiceId, services.price
 from invoice 
  join services  on services.ID=invoice.ServiceId where date(posting_date)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
$tseven+=$sevendays_sale;
 ...
 ?>
					...
					<div class="col-md-4 widget states-last">
						<?php
//Total Sale
 $query9=mysqli_query($con,"select invoice.service_Id as ServiceId, services.price
 from invoice 
