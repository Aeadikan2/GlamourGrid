...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  services set service_name='$sername',description='$serdesc',price='$price' where ID='$eid' ");
    if ($query) {
...
<html>
<head>
<title>GlarmourGrid | Update Services</title>
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Update GlarmourGrid Services:</h4>
						</div>
						<div class="form-body">
							<form method="post">
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Description</label> <textarea type="text" class="form-control" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"><?php  echo $row['description'];?></textarea> </div>
							 <div class="form-group"> <label for="exampleInputPassword1">Price</label> <input type="text" id="price" name="price" class="form-control" placeholder="Price" value="<?php  echo $row['price'];?>" required="true"> </div>
