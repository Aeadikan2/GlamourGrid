...
<html>
<head>
<title>GlarmourGrid || Manage Services</title>
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['service_name'];?></td> <td><?php  echo $row['price'];?></td><td><?php  echo $row['created_at'];?></td> <td>
