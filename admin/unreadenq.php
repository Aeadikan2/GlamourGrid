...
if($_GET['delid']){
$sid=$_GET['delid'];
mysqli_query($con,"delete from inquiries where ID ='$sid'");
...
<html>
<head>
<title>GlarmourGrid || Manage Read Enquiry</title>
...
<?php
$ret=mysqli_query($con,"select * from inquiries where IsRead is null");
$cnt=1;
...
?>
                 ...
                 <td><?php echo $cnt;?></td>
                  ...
                  <td><?php  echo $row['name'];?></td>
                                        ...
                                        <td>
                                            <span class="badge badge-primary"><?php echo $row['created_at'];?></span>
                                        </td>
