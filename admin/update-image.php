...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  services set Image='$newimage' where ID='$eid' ");
    if ($query) {
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Update GlamourGrid Services:</h4>
						</div>
						<div class="form-body">
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['service_name'];?>" readonly="true"> </div>
