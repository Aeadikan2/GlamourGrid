...
<html>
<head>
<title>GlarmourGrid || View Appointment</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<?php
$cid=$_GET['viewid'];
$ret=mysqli_query($con,"select users.name,users.email,bookings.PhoneNumber,bookings.ID as bid,bookings.AptNumber,bookings.AptDate,bookings.AptTime,bookings.Message,bookings.BookingsDate,bookings.Status from bookings join users on users.ID=bookings.users.ID where bookings.ID='$cid'");
$cnt=1;
...
<tr>
  ...
  <tr>
    <th>Apply Date</th>
    <td><?php  echo $row['BookingsDate'];?></td>
  </tr>
