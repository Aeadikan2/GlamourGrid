...
$vid=$_GET['viewid'];
$isread=1;
$query=mysqli_query($con, "update  inquiries set IsRead ='$isread' where ID='$vid'");

  ?>
<!DOCTYPE HTML>
<html>
<head>
<title>GlarmourGrid || Manage Unread Enquiry</title>
...
$ret=mysqli_query($con,"select * from inquiries where ID=$vid");
$cnt=1;
